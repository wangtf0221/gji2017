...
for j=1:nx
    lowvel_init_vp(:,j)=fread(fid1,[nz 1],'float32');
end
fclose(fid1);

fid1=fopen('True.vp','r');
for j=1:nx
    lowvel_vp(:,j)=fread(fid1,[nz 1],'float32');
end
fclose(fid1);
...
hold on
%%%%%%%%%%%%%%%%%%%for 20-160 data %%%%%%%%%%%%%
plot([1:nz],lowvel_vp([1:nz],aaaa),'k','linewidth',1.5);
plot([1:nz],lowvel_init_vp([1:nz],aaaa),'color','b','linewidth',1.5);
plot([1:nz],devp([1:nz],aaaa),'color',[0 204/255 51/255],'linewidth',1.5);
plot([1:nz],nodevp([1:nz],aaaa),'color',[1 204/255 0],'linewidth',1.5);
set(ax1,'ydir','normal','ylim',[1500 3000],'ytick',[1500:500:3000],'yticklabel','1.5|2.0|2.5|3.0','yaxislocation','left');
set(ax1,'xlim',[1 nz],'xtick',[1:62.5:nz],'xticklabel','0.0|1.0|2.0');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
plot([1:nz],lowvel_vs([1:nz],aaaa),'k','linewidth',1.5);
plot([1:nz],lowvel_init_vs([1:nz],aaaa),'color','b','linewidth',1.5);
plot([1:nz],devs([1:nz],aaaa),'color',[0 204/255 51/255],'linewidth',1.5);
plot([1:nz],nodevs([1:nz],aaaa),'color',[1 204/255 0],'linewidth',1.5);
